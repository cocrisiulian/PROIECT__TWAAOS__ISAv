    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-4xl w-full">
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-navy-800 text-gray-900">USV Events</h1>
          <p className="mt-2 text-gray-500">University Event Management System</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-md p-8 flex flex-col items-center justify-center">
            ...
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Student Sign In</h2>
            ...
            <p className="mt-4 text-xs text-gray-400">@student.usv.ro only</p>
          </div>

          {/* Staff Login */}
          <div className="bg-white rounded-2xl shadow-md p-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Staff Login</h2>
            <p className="text-sm text-gray-500 mb-6">For organizers and administrators.</p>
